  ...
  switch (action.type) {
    case GET_LOGIN_STATE: {
      return {
        ...
        isGitLab: action.payload.data.gitlab,
        loginTitle: action.payload.data.loginTitle,
...
export function loginGitLabActions(data) {
  return {
    type: LOGIN,
    payload: axios.post('/api/user/login_by_gitlab', data)
  };
}
